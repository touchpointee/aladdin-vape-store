                        ...
                        {previewImage && !imageFile && (
                            <div className="mt-2 text-sm text-gray-500">
                                ...
                                <div className="relative w-20 h-20 rounded border overflow-hidden mt-1">
                                    <Image src={previewImage} alt="Current Logo" fill className="object-cover" sizes="80px" unoptimized />
                                </div>
                            </div>
                        )}
                    </div>
                                ...
                                <td className="p-4">
                                    {brand.logo && (
                                        <div className="relative w-12 h-12 rounded overflow-hidden">
                                            <Image src={brand.logo} alt={brand.name} fill className="object-cover" sizes="48px" unoptimized />
                                        </div>
                                    )}
                                </td>
